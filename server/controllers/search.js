...
export const offerupSearch = async (req, res) => {
  ...
  const response = await fetch("https://offerup.com/api/graphql", {
    headers: {
      ...
      "ou-session-id":
        "web-62f68f88f8810b71a72d7d5e740ced91980e0feff61bf8c6714035bf@1680676585828",
      "sec-ch-ua":
