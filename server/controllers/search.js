...
export const offerupSearch = async (req, res) => {
  ...
  const response = await fetch("https://offerup.com/api/graphql", {
    headers: {
      ...
      "ou-session-id":
        "web-2ad41c5166dce52259c32839817397c6fa33800794df0b84675d330c@1680842752723",
      "sec-ch-ua":
